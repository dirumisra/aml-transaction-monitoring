...
import logging         # Used for logging execution steps, debugging, and production monitoring
import time            # Helps measure execution time → useful for performance tracking
import joblib          # Used to save/load trained ML models (serialize model to file)

import mlflow          # MLflow core module → used to track experiments (params, metrics, runs)
import mlflow.sklearn  # MLflow integration for sklearn → used to log models easily (e.g., RandomForest, LogisticRegression)
...
def main():
    """
    Orchestrate full XGBoost training pipeline with MLflow tracking.
    ...
    with mlflow.start_run(run_name="XGBoost"):
        ...
        # WHY:
        # - Uses XGBoost — sequential boosting approach
        # - Each tree fixes mistakes of previous tree
